...
export default function developersState(state = initialState, action) {
  ...
  switch (action.type) {
    ...
    case GET_DEVELOPERS_SUCCESS:
      return { ...state, ...{ isLoadingPending: false, isLoadingSuccess: true, developers: [...action.payload.developers] } };
    ...
    case DELETE_DEVELOPER_SUCCESS:
      _.remove(state.developers, { id: action.payload.id })
      return {
        isLoadingPending: false,
        isLoadingError: false,
        isLoadingSuccess: true,
    ...
    case UPDATE_DEVELOPER_SUCCESS:
      let index  = _.findIndex(state.developers, { id: action.payload.developer.id })
      state.developers[index] = action.payload.developer
      return {
        isLoadingPending: false,
        isLoadingError: false,
        isLoadingSuccess: true,
